...
for i = 1:2
    ...
    annotation(figure1,'textbox',...
        [0.544642857142857 0.813761906351362 0.168095570582709 0.0923809507914952],...
        'String','Chaos',...
        'Interpreter','latex',...
        'FontSize',18,...
        'FitBoxToText','off',...
    ...
    % Create arrow
    annotation(figure1,'arrow',[0.641071428571428 0.721428571428571],...
        [0.837095238095239 0.776190476190477],'LineWidth',2);
