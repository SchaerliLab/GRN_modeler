...
Ecoli = Ecoli.add_regulator('Activation_in','N1','HILL','P_N8');
Ecoli = Ecoli.add_regulator('Repression_in','N5','HILL','P_N1');
Ecoli = Ecoli.add_regulator('Repression_in','N1','HILL','P_N5');
Ecoli = Ecoli.add_regulator('Repression_in','N6','HILL','P_N2');
Ecoli = Ecoli.add_regulator('Repression_in','N2','HILL','P_N6');
Ecoli = Ecoli.add_regulator('Repression_in','N7','HILL','P_N3');
Ecoli = Ecoli.add_regulator('Repression_in','N3','HILL','P_N7');
Ecoli = Ecoli.add_regulator('Repression_in','N8','HILL','P_N4');
Ecoli = Ecoli.add_regulator('Repression_in','N4','HILL','P_N8');
...
!mkdir -p output
exportgraphics(gcf,'output/actolator8.pdf','Resolution',300)
