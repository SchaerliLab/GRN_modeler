...
Ecoli = Ecoli.add_regulator('Activation_in','N1','HILL','P_N6');
Ecoli = Ecoli.add_regulator('Repression_in','N5','HILL','P_N1');
Ecoli = Ecoli.add_regulator('Repression_in','N3','HILL','P_N5');
...
Ecoli = Ecoli.add_regulator('Repression_in','N2','HILL','P_N4');
...
!mkdir -p output
exportgraphics(gcf,'output/actilator6b.png','Resolution',300)
